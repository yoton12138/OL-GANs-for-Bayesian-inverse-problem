...
# resolution-independent, using the same networks as the pod_main.py
...
if __name__ == '__main__':
    ...
    # === model setting ===
    model = WGanGP2(coords_sensor_new_T, Opt.resp_features, means_nn, components_nn)
    model.load_models("save_models/pod_main_state/state_20000.pt")
