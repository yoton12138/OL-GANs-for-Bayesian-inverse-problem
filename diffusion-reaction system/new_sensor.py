...
# sigma, coords_sensor_new, obs_resp should be tuned carefully to ensure that the code runs
import numpy as np
...
if __name__ == '__main__':
    ...
    obs_resp = data["observation_02_r13_21"]  # choosing observation_r64_001, observation_r36_001
    ...
    # # 更新数据
    # data = dict(data)
    # data["observation_02_r13_21"] = obs_resp
    # data["coords_r13_21"] = coords_sensor_new
    # np.savez("data/meta_data_case3_length0.2_0807_4.npz", **data)
    ...
    # ==== model setting ===
    model = WGanGP(coords_params_T, coords_sensor_new_T, Opt.resp_features)
    ...
    posterior_joint = model.generate_fake_data(position_array_T, coords_params_T, coords_sensor_new_T).data.cpu().numpy()
    Opt.resp_features = 1089  #  33*33
    posterior_joint_grid = model.generate_fake_data(position_array_T, coords_params_T, coords_sensor_T).data.cpu().numpy()  # 33*33 grid
